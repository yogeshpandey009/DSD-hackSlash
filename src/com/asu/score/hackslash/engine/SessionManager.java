...
import com.asu.score.hackslash.views.TaskView;
import com.asu.score.hackslash.views.UsersView;

/**
 * This manager is responsible for the handling of the XMPPTCPConnection. This
 * is used for the changing of the users presence, the handling of connection
 * errors and the ability to add presence listeners and retrieve the connection
 * used in Spark.
 *
 */
public class SessionManager {
	 ...
	 *
	 * @param connection
	 *            the XMPPTCPConnection used in this session.
	 * @param username
	 *            the agents username.
	 * @param password
	 *            the agents password.
	 ...
	 */
	public void initializeSession(XMPPTCPConnection connection,
			String username, String password) throws NoResponseException,
