...
public class Constants {
	...
	public static final String DB_URL = "jdbc:mysql://52.32.136.81:3306/hackslash";
	public static final String PLUGIN_ID = "com.asu.score.hackslash";

	// Server Constants
	public static final String SERVER_IP_ADDRESS = "52.32.136.81";
	public static final int SERVER_PORT = 5222;
	public static final String SERVICE_NAME = "hackSlash";
	public static final String DB_USER_NAME = "root";

	public static final String DB_PASSWORD = "1qaz2wsx";
	public static final String SERVER_NAME = "@hackSlash-server";

	// Button Labels
	public static final String SEND_LABEL = "Send";
	public static final int GIT_COMMIT_LOGS_BUTTON_ID = 104;
}
