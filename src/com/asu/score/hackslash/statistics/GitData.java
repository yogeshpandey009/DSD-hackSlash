...
public class GitData {
	...
	private static final String GIT_PATH =  "/Users/HM/Google Drive/Project/DSD-hackSlash/.git";
	...
	public int getTotalCurrentMonthCommits() {
		Repository repo = GitControl.getInstance().getRepo();
		AuthorHistogramFilter afilter = new AuthorHistogramFilter();
		CommitFinder cfinder = new CommitFinder(repo);
		cfinder.setFilter(afilter).find();
	...
	public static void main(String[] args) throws IOException, GitAPIException{
		...
		//System.out.println(log.get(0).get(3));
	}
}
